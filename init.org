...
(setq-default display-fill-column-indicator-character ?│) ; Use solid line character
(global-display-fill-column-indicator-mode 1)

;; Customize the color of the fill column indicator
...
Python (pyright + ruff), LaTeX, TypeScript, JavaScript, Rust, C/C++, Typst, and more.
...
** Tree-sitter Auto
Automatically install and manage tree-sitter grammars for various languages.
This package will download and compile tree-sitter grammars as needed.
...
#+begin_src emacs-lisp
;; Configure tree-sitter language sources before treesit-auto
